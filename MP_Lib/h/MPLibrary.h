...
typedef s32 (__cdecl* Ttest_na)(const native_int Handle,const char* step,const char* AMsg);
...
typedef s32 (__cdecl* Ttest_export)(const char* csvfilePath, const char* HtmlFilePath);
...
typedef s32 (__cdecl* Ttsdiag_delete)(s32 ADiagModuleIndex);
typedef s32 (__cdecl* Ttsdiag_delete_all)();
...
typedef s32 (__cdecl* Ttsdiag_set_at_least_8bytes)(s32 ADiagModuleIndex, s32 AIs8Bytes);
typedef s32 (__cdecl* Ttsdiag_set_fcdelay)(s32 ADiagModuleIndex, s32 AFCDelay);
...
typedef s32 (__cdecl* Ttsdiag_lin_set_nad)(s32 ADiagModuleIndex, u8 ANAD);
...
typedef s32 (__cdecl* Ttsdiag_doip_set_version)(s32 ADiagModuleIndex, s32 AVersion);
...
typedef s32 (__cdecl* Ttsdiag_ui_get_handle_by_name)(char* AModuleName, ps32 APDiagModuleIndex);
typedef s32 (__cdecl* Ttsdiag_ui_load_db)(s32 ADiagModuleIndex, char* ADBPath);
typedef s32 (__cdecl* Ttsdiag_ui_get_service_list)(s32 ADiagModuleIndex, s32 AServiceID, char** AServiceList);
typedef s32 (__cdecl* Ttsdiag_ui_execute_service)(s32 ADiagModuleIndex, s32 AServiceID, char* AServiceName, char* AParameters, char** AResult);
typedef struct _TrtlUIDiagnostics {
    ...
    Ttsdiag_delete tsdiag_delete;
    Ttsdiag_delete_all tsdiag_delete_all;
    ...
    Ttsdiag_set_at_least_8bytes tsdiag_set_at_least_8bytes;
    Ttsdiag_set_fcdelay tsdiag_set_fcdelay;
    ...
    Ttsdiag_lin_set_nad tsdiag_lin_set_nad;
    Ttsdiag_doip_create tsdiag_doip_create;
    Ttsdiag_doip_set_version tsdiag_doip_set_version;
    ...
    Ttsdiag_ui_get_handle_by_name tsdiag_ui_get_handle_by_name;
    Ttsdiag_ui_load_db tsdiag_ui_load_db;
    Ttsdiag_ui_get_service_list tsdiag_ui_get_service_list;
    Ttsdiag_ui_execute_service tsdiag_ui_execute_service;
} TrtlUIDiagnostics;
